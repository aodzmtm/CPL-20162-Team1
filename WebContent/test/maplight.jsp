...
<fieldset>
	...
	<!-- <input id="power_off_total" value=""onclick="powerOffTotalFilter()"></input> 
	<input id="abnormal_blink_total" value=""onclick="abnormalBlinkTotalFilter()"></input> 
		<input id="short_circuit_total" value=""onclick="shortCircuitTotalFilter()"></input> 
		<input id="lamp_failure_total" value=""onclick="lampFailureTotalFilter()"></input> 
		<input id="lamp_state_total"value="" onclick="lampStateTotalFilter()"></input> -->
</fieldset>
</html>