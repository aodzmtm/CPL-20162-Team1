...
<div class="panel panel-primary" style="width:280px">
  <div class="panel-heading">
    <h3 class="panel-title">보안등 상태정보</h3>
  </div>
  <div class="panel-body">
	...
	border-top: 0px; border-bottom: 0px; border-left: 0px; border-right:0px">
  	<tbody>
  		...
  		<tr height="30px">
  			<td><span style="margin:5px">보안등 위치</span></td><td align="right"><input type="text" class="stateElement" id="location" value="" size="15" readonly></td>
  		</tr>
  		<tr height="30px">
  		...
  		<tr height="30px">
  			<td><span style="margin:5px">전원</span></td><td align="left"><div class="checks"><input type="checkbox" id="ex_chk" checked="checked" onClick="return false;"><label for="ex_chk"></label></div></td>
  		</tr>
  		<tr height="30px">
