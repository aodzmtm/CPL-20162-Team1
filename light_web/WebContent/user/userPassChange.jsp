...
<script>
	...
	function passwordValidate() {
		...
		var ObjUserID = document.getElementById("user_id");
		var ObjUserPassWord = document.getElementById("user_password");
...
<!-- #e5f7ff -->
<body bgcolor="#f0f5f7">
	<form name="joinForm" action="userPassChangeConf.do" method="post">
		...
		<div align="center" style="vertical-align: middle;">
			...
			<div style="margin-top: 200px;">
				...
				<input class="join_button" type="button" value="변경"
